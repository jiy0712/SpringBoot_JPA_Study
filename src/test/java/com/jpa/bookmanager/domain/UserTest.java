...
class UserTest {
    ...
    void test(){
        ...
        Users user1 = new Users(null, "s2325", "s2325@e-mirim.hs.kr", LocalDateTime.now(), LocalDateTime.now());
//        User user2 = new User("s2325", "s2325@e-mirim.hs.kr");
        ...
        Users user3 = Users.builder().name("s2325").email("s2325@e-mirim.hs.kr").build();
    }
}
